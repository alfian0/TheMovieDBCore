...
public final class CoreDataClient {
  ...
  public func fetchRequest<T: NSManagedObject>(_ type: T.Type, predicate: [String: Any]? = nil) -> AnyPublisher<[T], Error> {
  ...
  public func add<T: NSManagedObject>(_ type: T.Type, completion: @escaping (NSManagedObjectContext) -> Void) -> AnyPublisher<[T], Error> {
